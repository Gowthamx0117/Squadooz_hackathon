...
def predict_image(img_path):
    model.eval()
    image = Image.open(r"C:\\Users\\go1wt\\OneDrive\\Desktop\\project\\Squadooz_hackathon\\kvasir-dataset\\normal-pylorus\\0a0ce428-e7ee-4a42-9e60-b58b7cb6a06f.jpg").convert("RGB")
